  ...
  render() {
    ...
    return (
        ...
        <div className="container d-flex justify-content-between">
            ...
            <button disabled={this.state.page+1 > Math.ceil(this.results/this.props.pageSize)} type="button" className="btn btn-dark" onClick={this.handleNextclick}>Next&rarr;</button>
        </div>
      </div>
    </div>
    )
